...
def main():
    ...
    parser.add_argument('FILE',help='Summarize the disk utilization of each file or directory in FILE')
    parser.add_argument('-a','--all',help='Print for files too',action='store_true')
    parser.add_argument('-s','--summarize',help='Only print total disk utilization for each entry in FILE',action='store_true')
    ...
    for file1 in files:
        du(file1, 0, max_depth, print_files, units)
